			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="row" style="display: flow-root;">
						...
						<div class="col-md-5 col-sm-6" style="float:left">
        				    <div class="block-text rel zmin">
						        <a title="" href="#">${rlist.title }</a>
							    <div class="mark">My rating: <span class="rating-input">
							    <c:forEach var="i" begin="1" end="10">
							    	<c:if test="${i <= rlist.rating }">
							...
							<div class="person-text rel">
								<img width="50px" height="50px" src="/img/입.png" style="margin-top : 30px"/>
								<a title="" href="#">${rlist.writer }</a>
								<i>from 역삼</i>
							</div>
...
<section class="counting">
	<div class="layout">	
		  <div class="grid-1">
			<span class="count1 counter">★×${sumrating }</span>
			<p>이 식품이 받은 총 별의 개수</p>
		  </div> <!-- /.col-sm-3 -->
	</div>	
</section>	
						</div>
