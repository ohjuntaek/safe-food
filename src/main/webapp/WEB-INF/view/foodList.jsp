...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <!-- Main Content -->
            <div id="content" style="background-image: url(img/딸기.jpg); background-size: contain;">
                <!-- Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0" style="color: white;">식품 정보</h1>
                    </div>
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h5 class="h5 mb-0 text-black-800" style="color: red;">${msg }</h5>
                    </div>
                    <div class="row">
                                ...
                                <c:forEach var="i" items="${list}" begin="${0+j}" end="${16+j}" step="4">
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">
                                                1회 제공량 : ${i.supportpereat} <br> 칼로리 : ${i.calory}
                                            </p>
